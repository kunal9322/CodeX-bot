...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃', url=f"https://t.me/little_little_hackur")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/CoDexBoTupdate'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/CoDexBoTupdate')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ 𝐉𝐎𝐈𝐍  ✅', url='https://t.me/CoDexBoTupdate')
        ]]         
        reply_markup = InlineKeyboardMarkup(buttons)        
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('𝐉𝐎𝐈𝐍', url='https://t.me/CoDexBoTupdate') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
